export const projects = [
  ...
  {
    title: "String, Character & Integer Compiler",
    description:
      "Designed lexical and syntax analyzer phase of a compiler for a devised set of grammar rules and conditions for variable declaration. Lexical phase scans the input, generates token and pass them to the next phase. Syntax analyzer takes a stream of tokens generated by the lexical analyzer as input and reports errors in case of syntax misalignment.",
    techs: [
      "Flex",
      "Yacc",
      "C",
      "Node JS", "HTML", "jQuery", "Ajax",
    ],
    github: "https://github.com/Shyam-Makwana/String-Char-Int-Compiler",
  },
  {
